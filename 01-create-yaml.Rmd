...
if ("googlesheets4" %in% installed.packages()[,"Package"]) {
    ...
    ss <- 'https://docs.google.com/spreadsheets/d/1-jN59YPubMhsE0lKNl4d4HdIuO_sViKmjbDLIsyWuSI/edit#gid=0'
    ...
    file_path <- "https://docs.google.com/spreadsheets/d/1-jN59YPubMhsE0lKNl4d4HdIuO_sViKmjbDLIsyWuSI/edit#gid=0&single=true&output=tsv"
